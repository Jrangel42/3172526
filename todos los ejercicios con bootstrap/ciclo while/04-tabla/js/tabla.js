...
function tab() {
    ...
    document.getElementById("10-20").innerHTML = countTenTwenty;
    document.getElementById("20-50").innerHTML = countTwentyFifty;
    document.getElementById("mas50").innerHTML = countMFifty;
}
